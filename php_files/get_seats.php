...
foreach ($seatsGrid as $rows => $columns) {
  foreach ($columns as $column_num => $seat_details) {
    ...
    echo "<div class='seat' data-seat-id='$seat_id' onclick=\"toggleSeat(this, '$is_available', '$type')\">";
    if (($type == 'Standard') && ($is_available == '1')) {
      echo "<img src='assets/cinema-seating/available-seat.svg' data-original-src='assets/cinema-seating/available-seat.svg' style='cursor: pointer;'>";
      ...
      echo "<img src='assets/cinema-seating/wheelchair-seat.svg' data-original-src='assets/cinema-seating/wheelchair-seat.svg' style='cursor: pointer;'>";
